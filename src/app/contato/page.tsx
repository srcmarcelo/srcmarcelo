...
export default function Page() {
  const scrollContactCards = () => {
    const allProjectsSection = document.getElementById('contact-cards');
    ...
    <div>
      <div className='flex flex-col min-h-screen p-6'>
        ...
        <main className='flex flex-col md:flex-row overflow-hidden justify-center py-16 items-center flex-1 w-full h-full relative'>
          ...
          <BouncingArrow onScroll={scrollContactCards} />
        </main>
      </div>

      <div className='py-10 mb-16 w-full p-2'>
        <div
          id='contact-cards'
